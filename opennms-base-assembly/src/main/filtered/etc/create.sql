...
--# monitoringSystem : The UUID of the monitoring system
...
CREATE TABLE scanreport (
    ...
    CONSTRAINT scanreport_monitoringsystems_fkey FOREIGN KEY (monitoringSystem) REFERENCES monitoringsystems (id) ON DELETE CASCADE
);
